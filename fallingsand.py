		...
		if countdownMS < 0.0:
			...
			if pygame.mouse.get_pressed()[0]:
				...
				if size == 1:
					...
					grid.add_cell(xpos, ypos)
					grid.add_cell(xpos+1, ypos)
					grid.add_cell(xpos, ypos+1)
					grid.add_cell(xpos+1, ypos+1)
				elif size == 3:
					grid.add_cell(xpos, ypos)
					grid.add_cell(xpos, ypos+1)
					grid.add_cell(xpos+1, ypos)
					...
					grid.add_cell(xpos, ypos+1)
					grid.add_cell(xpos+1, ypos+1)
					grid.add_cell(xpos+2, ypos)
					grid.add_cell(xpos+2, ypos+1)
					grid.add_cell(xpos, ypos-1)
					grid.add_cell(xpos-1, ypos)
					grid.add_cell(xpos-1, ypos+1)
					grid.add_cell(xpos, ypos+2)
					grid.add_cell(xpos+1, ypos+2)
